...
import { Landmark, Building2, BadgeCheck, LineChart, Briefcase, ShieldCheck, ArrowUpRight } from "lucide-react";
    ...
    const services = [
        {
            ...
            points: ["Title-audited plots", "Installment options", "Legal handover"],
        },
        {
            icon: Building2,
            ...
            points: ["Security & upkeep", "Tenant handling", "Monthly reports"],
        },
        {
            icon: BadgeCheck,
            title: "Title Verification",
            body: "Independent legal audit of any land title, deed or purchase agreement. Know exactly what you're signing.",
            points: ["Land Conservation checks", "Boundary survey", "Encumbrance report"],
        },
        {
            icon: LineChart,
        ...
        },
        {
            ...
            points: ["Feasibility studies", "Master planning", "Public-private partnerships"],
        },
    ];
    ...
    return (
        <>
         <Head title="Services — Rocheli Real Properties">
            ...
            content="A full real-estate stack: sales, management, advisory and more."
            />
          </Head>
            ...
            <div className="container-x">
                <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-blue text-white p-10 md:p-14 grain">
                    ...
                    title={
                        ...
                        <span className="italic text-gradient-gold">Talk to us.</span>
                        </span>
                    }
                    />
                    ...
                    <Button
                        asChild
                        className="bg-gradient-gold text-navy rounded-full h-13 h-14 px-7 font-semibold hover:opacity-95"
                    >
                    ...
                    <Button
                        asChild
                        variant="outline"
                        className="rounded-full h-14 px-6 border-white/30 bg-white/10 text-white hover:bg-white/20"
                    >
                        <Link href="/properties">See live inventory</Link>
                    </Button>
                    </div>
                </div>
            </div>
