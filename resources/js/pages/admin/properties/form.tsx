    ...
    <>
      ...
      <div>
        <AdminPageHeader
          ...
          description="Listing shown on the public site and to members."
          action={
        ...
        <div className="mt-6 grid gap-6 lg:grid-cols-[240px_1fr] items-start">
          ...
          <section className="border border-border bg-card p-6 md:p-8 space-y-5">
            <div className="flex items-center justify-between">
              <h2 className="font-display text-xl font-semibold">{sections.find((s) => s.key === activeSection)?.label}</h2>
